...
const WebBigBlock = ({ categories }) => {
  ...
  return (
    <>
      <div className={`${styles.collection} ${styles.collectionHomePageBlock}`}>
        <div className={styles.content}>
          {sortedReviews.slice(0, 1).map(d => {
            return (
              <article className={`${styles.article} ${styles.featuredPrimary}`} key={d.id}>
