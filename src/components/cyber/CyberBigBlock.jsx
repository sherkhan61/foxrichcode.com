...
import * as classes from "../../styles/cyber/CyberBigBlock.module.scss"
...
const CyberBigBlock = ({ categories }) => {

  let webObject = categories.find((_o) => _o.node.strapiId === 3)
